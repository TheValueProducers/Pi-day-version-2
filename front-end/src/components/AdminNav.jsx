    ...
    <div className='w-full bg-white shadow-md'>
      ...
      <div className='w-full flex items-center justify-between md:hidden'>
        ...
        {/* Mobile Menu Options */}
          {menuOption &&
              ...
              <a className="w-full flex-grow text-white bg-[#8E74D0] hover:bg-[#886fc7] text-lg text-center py-4"> Manage Accounts</a>
              <a className="w-full flex-grow text-white bg-[#8E74D0] hover:bg-[#886fc7] text-lg text-center py-4"> Dashboard</a>
      ...
      <div className='flex  w-full items-center justify-between  '>
          ...
          <div className="w-2/3 flex items-center gap-4 justify-center">
              ...
              <a className=" text-black whitespace-nowrap py-1 hover:text-[#886fc7] px-4 lg:px6  font-medium   text-sm lg:text-lg  ">Manage Accounts</a>
              <a className=" text-black  hover:text-[#886fc7] py-1 font-medium px-4 lg:px6  text-sm lg:text-lg  ">Dashboard</a>
          </div>
