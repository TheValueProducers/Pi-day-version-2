    ...
    <div className='w-full bg-white shadow-md'>
      ...
      <div className='flex  w-full items-center justify-between  '>
          ...
          <div className="w-5/6 hidden md:flex justify-around items-center">
              ...
              {desktopMenuDropDown && (
                <div 
                  className="absolute top-full left-1/2 -translate-x-1/2 mt-8 w-48 bg-white shadow-lg rounded-lg border-[0] z-50 flex flex-col"
                  onMouseEnter={openDesktopDropDownMenu} // Keeps dropdown open
                  onMouseLeave={closeDesktopDropDownMenu} // Delayed close
                >
                  <a className="w-full text-black hover:bg-[#8E74D0] hover:text-white text-lg text-center py-3 transition rounded-t-lg">
                    About Pi Day
                  </a>
                  ...
                  <a className="w-full text-black hover:bg-[#8E74D0] hover:text-white text-lg text-center py-3 transition rounded-b-lg">
                    Our Team
                  </a>
                </div>
        )}
